...
export const components: DemoMeta[] = [
  ...
  { slug: "aspect-ratio", name: "Aspect Ratio", description: "Displays content within a desired ratio.", registryName: "aspect-ratio", isCustom: false, hasDemo: false },
  ...
  { slug: "chart", name: "Chart", description: "Beautiful charts built using Recharts.", registryName: "chart", isCustom: false, hasDemo: false },
  ...
  { slug: "collapsible", name: "Collapsible", description: "An interactive component which expands/collapses a panel.", registryName: "collapsible", isCustom: false, hasDemo: false },
  ...
  { slug: "form", name: "Form", description: "Building forms with React Hook Form and Zod.", registryName: "form", isCustom: false, hasDemo: false },
  ...
  { slug: "navigation-menu", name: "Navigation Menu", description: "A collection of links for navigating websites.", registryName: "navigation-menu", isCustom: false, hasDemo: false },
  ...
  { slug: "resizable", name: "Resizable", description: "Accessible resizable panel groups and layouts.", registryName: "resizable", isCustom: false, hasDemo: false },
  ...
  { slug: "toggle-group", name: "Toggle Group", description: "A set of two-state buttons that can be toggled on or off.", registryName: "toggle-group", isCustom: false, hasDemo: false },
  { slug: "tooltip", name: "Tooltip", description: "A popup that displays information related to an element.", registryName: "tooltip", isCustom: false, hasDemo: false },
]
