...
export const components: DemoMeta[] = [
  ...
  { slug: "button-group", name: "Button Group", description: "Groups related buttons together with shared borders and separators.", registryName: "button-group", isCustom: false, hasDemo: true },
  ...
  { slug: "combobox", name: "Combobox", description: "An autocomplete input with a filterable dropdown list.", registryName: "combobox", isCustom: false, hasDemo: true },
  ...
  { slug: "direction", name: "Direction", description: "A provider for setting and reading text direction (LTR/RTL).", registryName: "direction", isCustom: false, hasDemo: true },
  ...
  { slug: "empty", name: "Empty", description: "An empty state placeholder for when there is no data to display.", registryName: "empty", isCustom: false, hasDemo: true },
  { slug: "field", name: "Field", description: "A form field layout component with label, description, and error support.", registryName: "field", isCustom: false, hasDemo: true },
  ...
  { slug: "item", name: "Item", description: "A versatile list item component with media, content, and actions.", registryName: "item", isCustom: false, hasDemo: true },
  { slug: "kbd", name: "Kbd", description: "Displays a keyboard shortcut or key combination.", registryName: "kbd", isCustom: false, hasDemo: true },
  ...
  { slug: "native-select", name: "Native Select", description: "A styled wrapper around the native HTML select element.", registryName: "native-select", isCustom: false, hasDemo: true },
