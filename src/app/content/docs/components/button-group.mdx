...
```bash
npx shadcn@latest add https://vitality-shad.vercel.app/r/button-group.json
```

<ComponentSource
  name="button-group"
  title="registry/vitality/ui/button-group.tsx"
/>
...
```tsx
import { ButtonGroupText } from "@/registry/vitality/ui/button-group";
