...
<ComponentPreview className="-m-6" name="sidebar/demo" />
...
```bash
npx shadcn@latest add https://vitality-shad.vercel.app/r/sidebar.json
```
...
import { SidebarProvider, SidebarTrigger } from "@/registry/vitality/ui/sidebar"
...
```tsx title="registry/vitality/ui/sidebar.tsx"
...
```tsx
import { useSidebar } from "@/registry/vitality/ui/sidebar"
