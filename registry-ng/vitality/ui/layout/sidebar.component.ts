...
import { ZardIconComponent, type ZardIcon } from '@/ui/icon/icon.component';
import {
...
export class SidebarComponent {
  ...
  protected readonly classes = computed(() => cn(sidebarVariants(), this.class()));

  protected readonly triggerClasses = computed(() => cn(sidebarTriggerVariants()));
...
export class SidebarGroupComponent {
  ...
  protected readonly classes = computed(() => cn(sidebarGroupVariants(), this.class()));
}
...
export class SidebarGroupLabelComponent {
  ...
  protected readonly classes = computed(() => cn(sidebarGroupLabelVariants(), this.class()));
}
