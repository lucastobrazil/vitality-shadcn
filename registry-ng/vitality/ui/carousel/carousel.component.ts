...
export class ZardCarouselComponent {
  ...
  protected readonly classes = computed(() =>
    cn(carouselVariants({ zOrientation: this.zOrientation() }), this.class()),
  );

  protected readonly prevBtnClasses = computed(() =>
    cn(carouselPreviousButtonVariants({ zOrientation: this.zOrientation() })),
  );

  protected readonly nextBtnClasses = computed(() =>
    cn(carouselNextButtonVariants({ zOrientation: this.zOrientation() })),
  );
}
