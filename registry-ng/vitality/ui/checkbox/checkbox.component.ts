...
export class ZardCheckboxComponent implements ControlValueAccessor {
  ...
  protected readonly classes = computed(() =>
    cn(checkboxVariants({ zType: this.zType(), zSize: this.zSize(), zShape: this.zShape() }), this.class()),
  );

  readonly disabledByForm = signal(false);
  protected readonly labelClasses = computed(() => cn(checkboxLabelVariants({ zSize: this.zSize() })));
