...
export const breadcrumbItemVariants = cva(
  'inline-flex items-center gap-1.5 transition-colors cursor-pointer text-primary hover:text-primary/80 last:text-foreground last:font-normal last:pointer-events-none',
);
