...
export class ZSliderTrackComponent {
  ...
  protected readonly classes = computed(() =>
    cn(sliderTrackVariants({ zOrientation: this.orientation() }), this.class()),
  );
...
export class ZSliderRangeComponent {
  ...
  protected readonly classes = computed(() =>
    cn(sliderRangeVariants({ zOrientation: this.orientation() }), this.class()),
  );
}
...
export class ZSliderThumbComponent {
  ...
  protected readonly classes = computed(() =>
    cn(sliderThumbVariants({ disabled: this.disabled() }), this.class()),
  );

  protected readonly orientationClasses = computed(() =>
    cn(sliderOrientationVariants({ zOrientation: this.orientation() })),
  );
...
export class ZardSliderComponent implements ControlValueAccessor, AfterViewInit, OnChanges, OnDestroy {
  ...
  protected readonly classes = computed(() =>
    cn(sliderVariants({ orientation: this.zOrientation() }), this.class()),
  );
