...
import { ZardIdDirective, ZardStringTemplateOutletDirective } from '@/lib/core';
...
export class ZardCardComponent {
  ...
  protected readonly classes = computed(() => cn(cardVariants(), this.class()));
  protected readonly bodyClasses = computed(() => cn(cardBodyVariants()));
  protected readonly footerClasses = computed(() =>
    cn(cardFooterVariants(), this.zFooterBorder() ? 'border-t' : ''),
  );

  protected readonly headerClasses = computed(() =>
    cn(cardHeaderVariants(), this.zHeaderBorder() ? 'border-b' : ''),
  );
