...
import { commandVariants, type ZardCommandSizeVariants } from './command.variants';
import type { ZardIcon } from '@/ui/icon';
...
export class ZardCommandComponent implements ControlValueAccessor, ZardCommand {
  ...
  protected readonly classes = computed(() => cn(commandVariants({ size: this.size() }), this.class()));
