...
import { ZardSelectItemComponent } from '@/ui/select/select-item.component';
import { ZardSelectComponent } from '@/ui/select/select.component';
...
export class ZardCalendarNavigationComponent {
  ...
  protected readonly navClasses = computed(() => cn(calendarNavVariants()));
