...
import { ZardIdDirective } from '@/lib/id.directive';
import {
  isTemplateRef,
  ZardStringTemplateOutletDirective,
} from '@/lib/string-template-outlet.directive';
...
import type { ZardInputSizeVariants } from '@/ui/input/input.variants';
...
export class ZardInputGroupComponent {
  ...
  protected readonly addonBeforeClasses = computed(() =>
    cn(this.addonClasses('before'), this.isAddonBeforeTemplate() ? 'pr-0.5' : ''),
  );
