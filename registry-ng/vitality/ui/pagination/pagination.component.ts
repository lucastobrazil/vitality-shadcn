...
export class ZardPaginationContentComponent {
  ...
  protected readonly classes = computed(() => cn(paginationContentVariants(), this.class()));
}
...
export class ZardPaginationPreviousComponent {
  ...
  protected readonly classes = computed(() => cn(paginationPreviousVariants(), this.class()));
}
...
export class ZardPaginationNextComponent {
  ...
  protected readonly classes = computed(() => cn(paginationNextVariants(), this.class()));
}
...
export class ZardPaginationEllipsisComponent {
  ...
  protected readonly classes = computed(() => cn(paginationEllipsisVariants(), this.class()));
}
