...
export class ZardTableHeaderComponent {
  ...
  protected readonly classes = computed(() => cn(tableHeaderVariants(), this.class()));
}
...
export class ZardTableBodyComponent {
  ...
  protected readonly classes = computed(() => cn(tableBodyVariants(), this.class()));
}
...
export class ZardTableRowComponent {
  ...
  protected readonly classes = computed(() => cn(tableRowVariants(), this.class()));
}
...
export class ZardTableHeadComponent {
  ...
  protected readonly classes = computed(() => cn(tableHeadVariants(), this.class()));
}
...
export class ZardTableCellComponent {
  ...
  protected readonly classes = computed(() => cn(tableCellVariants(), this.class()));
}
...
export class ZardTableCaptionComponent {
  ...
  protected readonly classes = computed(() => cn(tableCaptionVariants(), this.class()));
}
