...
export class ZardAccordionItemComponent {
  ...
  protected readonly itemClasses = computed(() => cn(accordionItemVariants(), this.class()));
  protected readonly triggerClasses = computed(() => cn(accordionTriggerVariants()));
  protected readonly contentClasses = computed(() => cn(accordionContentVariants({ isOpen: this.isOpen() })));
